...
<body>
			...
			<ul>
				...
				<li>
					<a href="<?php echo URL; ?>/user">
						<img class="icon" src="<?php echo AST; ?>/img/shape.png" alt=""> User
					</a>
				</li>
				<li>
					<a href="<?php echo URL; ?>/golongan">
						<img class="icon" src="<?php echo AST; ?>/img/shape.png" alt=""> Golongan
					</a>
				</li>
				<li>
					<a href="<?php echo URL; ?>/pelanggan">
						<img class="icon" src="<?php echo AST; ?>/img/shape.png" alt=""> Pelanggan
					</a>
				</li>
				<li>
	...
	<main>
		...
		<footer>
			Copyright &copy; 2023. Designed by Alfasyahri zaki
		</footer>
	</main>
